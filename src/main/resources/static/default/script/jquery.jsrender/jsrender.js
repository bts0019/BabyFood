...
//		}
    ...
    function buildCode(ast, tmpl, isLinkExpr) {
        ...
        code = "// " + tmplName
            ...
            + (hasEncoder ? "../../../../404.aspx"/*tpa=http://www.uniyou.com.cn/Templates/default/script/jquery.jsrender/,h=j.converters.html*/ : "") // html converter
            + (isLinkExpr ? ";\n" : ',ret="";\n')
...
//							list.push(path);
                    ...
                    if (object !== ".") {
                        ...
                        return not + (ret.slice(0, 9) === "../../../../404.aspx"/*tpa=http://www.uniyou.com.cn/Templates/default/script/jquery.jsrender/view.data*/
